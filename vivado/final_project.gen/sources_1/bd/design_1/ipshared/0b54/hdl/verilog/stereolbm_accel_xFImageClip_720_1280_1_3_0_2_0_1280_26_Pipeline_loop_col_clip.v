...
module stereolbm_accel_xFImageClip_720_1280_1_3_0_2_0_1280_26_Pipeline_loop_col_clip (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln637_1_fu_144_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        j_7_reg_209 <= ap_sig_allocacmp_j_7;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        in_sobel_x_i3_41_blk_n = in_sobel_x_i3_41_empty_n;
    end else begin
        in_sobel_x_i3_41_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        in_sobel_x_i3_41_read = 1'b1;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        left_clipped5_blk_n = left_clipped5_full_n;
    end else begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((left_clipped5_full_n == 1'b0) | (in_sobel_x_i3_41_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((left_clipped5_full_n == 1'b0) | (in_sobel_x_i3_41_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((left_clipped5_full_n == 1'b0) | (in_sobel_x_i3_41_empty_n == 1'b0)));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((left_clipped5_full_n == 1'b0) | (in_sobel_x_i3_41_empty_n == 1'b0));
end
...
assign icmp_ln622_fu_111_p2 = ((ap_sig_allocacmp_j_7 == width_load) ? 1'b1 : 1'b0);

assign icmp_ln637_1_fu_144_p2 = (($signed(tmp_fu_134_p4) > $signed(11'd0)) ? 1'b1 : 1'b0);

assign icmp_ln637_fu_128_p2 = (($signed(pix_1_xFImageClipUtility_1_s_fu_93_ap_return) < $signed(16'd65505)) ? 1'b1 : 1'b0);

assign j_8_fu_117_p2 = (ap_sig_allocacmp_j_7 + 11'd1);

assign left_clipped5_din = p_V_fu_174_p3;

assign or_ln637_fu_168_p2 = (icmp_ln637_fu_128_p2 | icmp_ln637_1_fu_144_p2);
...
endmodule //stereolbm_accel_xFImageClip_720_1280_1_3_0_2_0_1280_26_Pipeline_loop_col_clip
